    ...
    <div className="min-h-screen flex bg-surface-0">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-surface-200 border border-white/5 rounded-xl text-white placeholder:text-zinc-600 text-sm focus:outline-none input-glow transition-all"
                  id="register-name"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-12 py-3 bg-surface-200 border border-white/5 rounded-xl text-white placeholder:text-zinc-600 text-sm focus:outline-none input-glow transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-11 pr-12 py-3 bg-surface-200 border rounded-xl text-white placeholder:text-zinc-600 text-sm focus:outline-none input-glow transition-all ${
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center hero-gradient overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-brand-500/10 rounded-full blur-3xl animate-glow-pulse" />
          <div
            className="absolute bottom-1/3 left-1/3 w-56 h-56 bg-accent-500/8 rounded-full blur-3xl animate-glow-pulse"
        ...
        <div className="relative z-10 max-w-md px-12">
          ...
          >
            ...
            <h2 className="text-3xl font-display font-bold mb-4 leading-snug">
              Start your{" "}
              <span className="gradient-text">career journey</span> today
            </h2>
