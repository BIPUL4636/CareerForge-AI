    ...
    <div className="min-h-screen flex bg-surface-0">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center hero-gradient overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 left-1/3 w-72 h-72 bg-brand-500/10 rounded-full blur-3xl animate-glow-pulse" />
          <div
            className="absolute bottom-1/3 right-1/3 w-56 h-56 bg-accent-500/8 rounded-full blur-3xl animate-glow-pulse"
